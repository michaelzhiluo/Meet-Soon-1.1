...
@implementation CalendarMonthLogic
...
- (void)setReferenceDate:(NSDate *)aDate {
	...
	NSDateComponents *components = [[NSCalendar autoupdatingCurrentCalendar] components:(NSDayCalendarUnit | NSMonthCalendarUnit | NSYearCalendarUnit) fromDate:aDate];	
	referenceDate = [[NSCalendar autoupdatingCurrentCalendar] dateFromComponents:components];
...
+ (NSDate *)dateForWeekday:(NSInteger)aWeekday onWeek:(NSInteger)aWeek referenceDate:(NSDate *)aReferenceDate {
	NSDateComponents *components = [[NSCalendar autoupdatingCurrentCalendar] components:(NSMonthCalendarUnit | NSYearCalendarUnit) fromDate:aReferenceDate];
...
- (void)selectPreviousMonth {
	...
	[DataFetchUtil saveButtonsEventRecord:@"p"];
	NSCalendar *calendar = [NSCalendar autoupdatingCurrentCalendar];
...
- (void)selectNextMonth {
    //added Button click Event
	[DataFetchUtil saveButtonsEventRecord:@"q"];
	NSCalendar *calendar = [NSCalendar autoupdatingCurrentCalendar];
